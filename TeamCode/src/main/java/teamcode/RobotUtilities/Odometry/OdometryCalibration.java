 ...
 * teamcode.RobotUtilities.Odometry system calibration. Run this OpMode to generate the necessary constants to calculate the robot's global position on the field.
 * The Global Positioning Algorithm will not function and will throw an error if this program is not run first
 */
//@Disabled
@TeleOp(name = "teamcode.RobotUtilities.Odometry System Calibration", group = "Calibration")
public class OdometryCalibration extends LinearOpMode {
    ...
    String rfName = "Front_Right_Motor", rbName = "Rear_Right_Motor", lfName = "Front_Left_Motor", lbName = "Rear_Left_Motor";
    String verticalLeftEncoderName = "Ducky_Disk", verticalRightEncoderName = "rightArmMotor", horizontalEncoderName = "Intake";
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addData("teamcode.RobotUtilities.Odometry System Calibration Status", "IMU Init Complete");
        telemetry.clear();

        //teamcode.RobotUtilities.Odometry System Calibration Init Complete
        telemetry.addData("teamcode.RobotUtilities.Odometry System Calibration Status", "Init Complete");
        telemetry.update();
       ...
       */
        ...
        while(opModeIsActive()){
            telemetry.addData("teamcode.RobotUtilities.Odometry System Calibration Status", "Calibration Complete");
