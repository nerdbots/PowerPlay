...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    //teamcode.RobotUtilities.Odometry encoder wheels
    ...
    String verticalLeftEncoderName = "Left", verticalRightEncoderName = "Right", horizontalEncoderName = "Back";
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("Horizaontal Encoder", horizontal.getCurrentPosition());
