...
//        telemetry.update();
        if (purePursuitPath == 1) {
            ...
            allPoints.add(new CurvePoint(23.5, 52.5, 0.95, 0.5, 12, 0, 0));
            ...
            allPoints.add(new CurvePoint(23.5, 51.5, 0.9, 0.5, 12, 0, 0));
        ...
        if(path == 1){
            ...
            allPoints.add(new CurvePoint(-11, 50, 0.8, 0.3, 12, 0, 60));
