...
//@Disabled
@Autonomous(name="Powerplay RED RIGHT 3 Cone side", group="Linear Opmode")

public class Powerpplay_RED_RIGHT_3_Cone extends LinearOpMode {
...
//            ArrayList<CurvePoint> allPoints = new ArrayList<>();
            ...
            allPoints.add(new CurvePoint(5, 41, 0.4, 0.3, 25, 0, 0.3));
            allPoints.add(new CurvePoint(5, 77, 0.4, 0.3, 25, 0, 0.3));
...
//                myPurePursuitRobotMovement6_Turn_MultiThread.moveArmsOnly(ArmShoulderPositions.S4,-400, FingerPositions.GRAB);
            ...
            allPoints.add(new CurvePoint(1.5, 53.5, 0.4, 0.2, 12, 0, 0.3));
            allPoints.add(new CurvePoint(-15, 53.5, 0.4, 0.2, 12, 0, 0.3));
            ...
            allPoints = new ArrayList<>();
            allPoints.add(new CurvePoint(6, 43, 0.4, 0.3, 12, 0, 0.3));
            ...
            allPoints = new ArrayList<>();
            allPoints.add(new CurvePoint(5, 51, 0.4, 0.3, 12, 0, 0.3));
            allPoints.add(new CurvePoint(-4, 54, 0.4, 0.3, 12, 0, 0.3));
            allPoints.add(new CurvePoint(-25, 54, 0.4, 0.3, 12, 0, 0.3));
...
//        }
        if(path == 2){
            ...
            allPoints.add(new CurvePoint(7,53 , 0.4, 0.3, 12, 0, 0.3));
            allPoints.add(new CurvePoint(20, 53, 0.4, 0.3, 12, 0, 0.3));
        ...
        if(path == 1){
            ...
            allPoints.add(new CurvePoint(-17,52 , 0.2, 0.3, 12, 0, 0.3));
            allPoints.add(new CurvePoint(-35, 52, 0.2, 0.3, 12, 0, 0.3));
